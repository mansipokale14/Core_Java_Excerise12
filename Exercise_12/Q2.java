...
public class Q2 {
 public static void main(String[] args) {
     ...
     FullTimeEmployee fullTimeEmp = new FullTimeEmployee("Mansi", "FT123", "Software Engineer", 60000);
     ...
     PartTimeEmployee partTimeEmp = new PartTimeEmployee("Priya", "PT456", "Data Analyst", 25, 100);
